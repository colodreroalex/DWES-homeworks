...
// =============================================
// FUNCIÓN: Generar miniatura con Imagick
// =============================================
function generarMiniatura($rutaOrigen, $rutaDestino, $anchoMaximo, $altoMaximo) {
    try {
        ...
        $imagen->thumbnailImage($anchoMaximo, $altoMaximo, true);
        ...
        // Manejar errores de Imagick
        error_log("Error al generar miniatura con Imagick: " . $e->getMessage());
        return false;
    }
}
